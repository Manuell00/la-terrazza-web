      ...
      >
        ...
        {compact && (
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="absolute top-[3%] left-0 right-0 mx-auto w-fit rounded-[20px] border border-white/90 bg-white/92 px-3.5 py-3 text-center text-stone-900 shadow-[0_20px_60px_-30px_rgba(28,25,23,0.32)] backdrop-blur-xl"
          >
        ...
        {compact && (
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="absolute bottom-[3%] left-0 right-0 mx-auto flex w-[13.25rem] items-center justify-center rounded-[22px] border border-stone-200 bg-white/95 px-3.5 py-3.5 text-center shadow-[0_24px_70px_-34px_rgba(28,25,23,0.38)] backdrop-blur-xl"
          >
            <div>
              <p className="text-[10px] font-semibold uppercase tracking-[0.24em] text-stone-500">La Terrazza</p>
              <p className="mt-1.5 font-serif text-[1.18rem] leading-[0.95] text-stone-900">
                {roomsCard}
          ...
          <div className="relative z-10 w-full px-4 pb-14 pt-28">
            ...
            >
              <motion.div variants={heroItemVariants} className="mb-5 inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-white/85 px-4 py-2 text-sm text-emerald-800 shadow-soft backdrop-blur-sm">
                ...
                <span className="tracking-wide">{t.location}</span>
              </motion.div>
              <motion.h1 variants={heroItemVariants} className="font-serif text-[2.75rem] font-semibold leading-[0.94] tracking-[-0.05em] text-stone-900">
                La Terrazza
                <span className="mt-1 block text-stone-500">{lang === "it" ? "Affittacamere" : "Guesthouse"}</span>
              </motion.h1>
              ...
              >
                <HeroIllustration
                  ...
                  roomsCard={t.roomsCard}
                  roomsCardSub={t.roomsCardSub}
                />
              </motion.div>
              ...
              >
                ...
                <Link
                  href={localizePath("/prenota", lang)}
          ...
          <div className="grid min-h-[720px] items-center gap-12 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:gap-16">
            ...
            >
              <div className="max-w-xl">
                ...
                >
                  La Terrazza
                  <span className="block text-stone-500">{lang === "it" ? "Affittacamere" : "Guesthouse"}</span>
                </motion.h1>
            ...
            >
              ...
              >
                <div>
                  ...
                  <p className="mt-3 font-serif text-2xl leading-[0.95] text-stone-900">
                    {t.roomsCard}
                    <span className="block text-stone-500">{t.roomsCardSub}</span>
                  </p>
                </div>
              </motion.div>
              ...
              >
                <p className="text-[11px] font-semibold uppercase tracking-[0.24em] text-stone-500">{t.reviewsLabel}</p>
                <p className="mt-2 text-2xl font-semibold leading-none">{siteConfig.rating}/5</p>
                <p className="mt-2 text-[12px] text-stone-500">{t.reviewsCount}</p>
              </motion.div>
            </motion.div>
          </div>
        </div>
