  ...
  return (
    <footer className="bg-stone-900 text-stone-300">
      <div className="container mx-auto px-4 py-8 md:py-14">
        ...
        {/* ── Desktop: 3-column grid / Mobile: stacked compact ── */}
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8">

          {/* ── Brand ── */}
          <div className="flex flex-col items-center rounded-[22px] border border-white/6 bg-white/[0.04] px-5 py-5 text-center md:py-6">
            ...
            <div className="mt-2 flex gap-3">
              <a
                ...
                className="flex min-w-[7.25rem] items-center justify-center gap-2 rounded-full border border-white/18 bg-white/16 px-4 py-2.5 text-white shadow-[0_10px_28px_-16px_rgba(255,255,255,0.32)] transition-all duration-300 hover:border-emerald-400 hover:bg-emerald-600 hover:text-white hover:scale-110 hover:shadow-[0_18px_38px_-18px_rgba(16,185,129,0.85)] md:h-10 md:min-w-0 md:w-10 md:px-0"
              >
                <svg className="h-5.5 w-5.5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-xs font-semibold tracking-[0.08em] md:hidden">Instagram</span>
              </a>
              <a
              ...
              >
                ...
                <span className="text-xs font-semibold tracking-[0.08em] md:hidden">Facebook</span>
              </a>
            </div>
          </div>

          {/* ── Links ── */}
          <div className="rounded-[22px] border border-white/6 bg-white/[0.03] px-5 py-5 md:py-6">
