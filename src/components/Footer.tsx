          ...
          <div className="flex flex-col items-center rounded-[22px] border border-white/6 bg-white/[0.04] px-5 py-5 text-center md:py-6">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="flex h-11 w-11 items-center justify-center rounded-full bg-stone-800 text-stone-400 transition-all duration-200 hover:bg-emerald-600 hover:text-white hover:scale-105"
              >
