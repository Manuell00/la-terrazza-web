          ...
          <div className="flex flex-col items-center rounded-[22px] border border-white/6 bg-white/[0.04] px-5 py-5 text-center md:py-6">
            ...
            <div className="mt-2 flex gap-3">
              <a
                ...
                className="flex h-11 w-11 items-center justify-center rounded-full border border-white/18 bg-white/16 text-white shadow-[0_10px_28px_-16px_rgba(255,255,255,0.32)] transition-all duration-300 hover:border-emerald-400 hover:bg-emerald-600 hover:text-white hover:scale-110 hover:shadow-[0_18px_38px_-18px_rgba(16,185,129,0.85)] md:h-10 md:w-10"
              >
