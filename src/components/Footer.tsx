          ...
          <div className="flex flex-col items-center rounded-[22px] border border-white/6 bg-white/[0.04] px-5 py-5 text-center md:py-6">
            ...
            <div className="flex gap-3.5">
              <a
                ...
                className="flex h-10.5 w-10.5 items-center justify-center rounded-full bg-stone-800 text-stone-300 transition-all duration-300 hover:bg-emerald-600 hover:text-white hover:scale-125 hover:shadow-[0_18px_38px_-18px_rgba(16,185,129,0.85)]"
              >
