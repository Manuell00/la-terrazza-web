  ...
  it: {
    luna: {
      ...
      features: [
        ...
        { icon: "❄️", label: "Aria condizionata controllata" },
        { icon: "📶", label: "Wi-Fi gratuito" },
        { icon: "🪟", label: "Vista campagna" },
        { icon: "🎁", label: "Welcome kit" },
      ],
      amenities: [
        "Asciugamani inclusi",
        "TV smart",
  ...
  en: {
    luna: {
      ...
      features: [
        ...
        { icon: "❄️", label: "Controlled air conditioning" },
