    ...
    <main className="pt-20">
      ...
      <section className="relative overflow-hidden bg-stone-900 py-24">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <AnimatedSection>
            <div className="mx-auto max-w-3xl rounded-[30px] border border-white/12 bg-stone-950/34 px-6 py-8 shadow-[0_24px_70px_-34px_rgba(0,0,0,0.7)] backdrop-blur-md md:px-10 md:py-10">
