    ...
    <main className="pt-20">
      <section className="relative overflow-hidden bg-stone-900 py-24">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <AnimatedSection>
            <div className="relative isolate mx-auto max-w-3xl overflow-hidden rounded-[30px] border border-white/14 px-6 py-8 shadow-[0_28px_80px_-34px_rgba(0,0,0,0.72)] md:px-10 md:py-10">
              <div className="absolute inset-0 -z-10 bg-[rgba(12,10,9,0.46)]" />
              <div className="absolute inset-0 -z-10 bg-[linear-gradient(180deg,rgba(255,255,255,0.04)_0%,rgba(255,255,255,0.01)_100%)]" />
